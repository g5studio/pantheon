...
1. 拉取 Pantheon 最新內容
2. 重建 `.cursor` 與 `.agent` 下的 Pantheon 安裝內容
3. 更新或確認 `.gitignore`
...
|---|---|
| `.pantheon/.cursor/scripts/cr/agent-commit.mjs` | `.cursor/scripts/{deities}/cr/agent-commit.mjs`、`.agent/scripts/{deities}/cr/agent-commit.mjs` |
| `.pantheon/.cursor/scripts/notification/notify-cursor-rules-failed.mjs` | `.cursor/scripts/{deities}/notification/notify-cursor-rules-failed.mjs`、`.agent/scripts/{deities}/notification/notify-cursor-rules-failed.mjs` |
| `.pantheon/.cursor/rules/*.mdc` | `.cursor/rules/{deities}/*.mdc` |
| `.pantheon/.cursor/commands/*.md` | `.cursor/commands/{deities}/*.md`、`.agent/commands/{deities}/*.md` |
| `.pantheon/.cursor/skills/*/SKILL.md` | `.cursor/skills/{deities}/*/SKILL.md`、`.agent/skills/{deities}/*/SKILL.md` |
