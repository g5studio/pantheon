...
| `evolve` | 將專案改造成適合 Operator Agent 操作的生態 | `project-schema` skill、`misnamed-file-report.md`、註解補全 |

`evolve` 需在 `adapt` 完成後執行。詳見 `.cursor/commands/utilities/adapt.md` 與 `.cursor/commands/utilities/evolve.md`。
